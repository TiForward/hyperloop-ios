...
function generateCustomClass(options, state, metabase, classname, filename) {
	...
	addExtern('EXPORTAPI JSObjectRef '+classToJSValue+'(JSContextRef, '+classType.toCast()+', JSValueRef *);');
	addExtern('EXPORTAPI JSObjectRef '+superClassToJSValue+'(JSContextRef, '+superType.toCast()+', JSValueRef *);');
